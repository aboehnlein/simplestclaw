              ...
              <div className="mt-16 grid lg:grid-cols-2 gap-4 max-w-4xl mx-auto">
                ...
                >
                  ...
                  <p className="text-[15px] text-white/50 leading-relaxed mb-4">
                    Download the open source desktop app. Everything runs on your machine. Your data
                    never leaves.
                  </p>
            ...
            <div className="mt-16">
              ...
              <div className="max-w-2xl mx-auto">
                  ...
                  <ul className="space-y-3 text-[14px]">
                    ...
                    <li className="flex items-start gap-2">
                      ...
                      <div>
                        ...
                        <span className="text-white/40">
                          {' '}
                          Just open the app and start using OpenClaw.
                        </span>
                      </div>
                    </li>
                    <li className="flex items-start gap-2">
                ...
                <div className="mt-8 pt-8 border-t border-white/5">
                  <p className="text-[13px] text-white/40 mb-4 text-center">
            ...
            <div className="mt-16">
              ...
              <div className="max-w-2xl mx-auto">
                ...
                <div className="mt-8 p-5 rounded-xl bg-white/[0.02] border border-white/5">
                  ...
                  <p className="text-[13px] text-white/40 mb-1 pt-4 border-t border-white/5">
                    What you get:
                  </p>
                  ...
                  <p className="text-[12px] text-white/30 mt-4 pt-4 border-t border-white/5">
                    <span className="text-red-400">Note*</span> Requires Railway Hobby plan
                    ($5/month). Free trial has memory limits.
                  </p>
                </div>
